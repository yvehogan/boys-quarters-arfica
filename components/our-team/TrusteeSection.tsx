    ...
    <div className='bg-white py-12 md:px-20 px-4'>
      ...
      <div className='w-full'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
          {trustees.slice(0, 4).map((trustee, index) => (
            <div
              key={index}
        ...
        <div className='md:col-span-3 mt-6 flex md:flex-row flex-col items-center justify-center gap-6'>
          {trustees.slice(4).map((trustee, index) => (
            <div
              key={index}
              className='flex flex-col sm:max-w-[263px] w-full bg-white rounded-xl shadow-sm overflow-hidden'
            >
              <div className='aspect-square relative w-full overflow-hidden'>
                <img
                  src={trustee.image}
