...
const Footer = () => {
  ...
  return (
    <div className="mt-16 lg:mt-24 bg-[#161616] text-[#F7F8FA]">
        ...
        <div className="flex flex-col lg:flex-row md:justify-between items-center">
          <div className="flex items-start gap-4 lg:gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-5 mt-12 mb-10  lg:mb-20">
          ...
          <form
            ...
            className="mt-3 lg:mt-6 mb-10 lg:mb-0 relative"
          >
            ...
            <button
              type="submit"
              className="bg-primary text-white py-2 px-6 rounded-lg absolute right-1 bottom-1"
            >
