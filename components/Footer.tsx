...
const Footer: React.FC<footerProps> = ({ className }) => {
  ...
  const socialLinks = [
    {
      icon: FaFacebookF,
      url: "https://www.facebook.com/BoysQAfrica",
      name: "Facebook",
    },
    {
      icon: FaLinkedinIn,
      url: "https://www.linkedin.com/company/boys-quarters-africa/",
      name: "LinkedIn",
    },
    {
      icon: FaXTwitter,
      url: "https://x.com/boysqafrica?t=lsGGgv-idgi3G8s8l9yf4Q&s=09",
      name: "Twitter",
    },
    {
      icon: BiLogoInstagramAlt,
      url: "https://www.instagram.com/boysqafrica?igsh=MTFhYm9neXRlM283dg==",
      name: "Instagram",
    },
    {
      icon: FaYoutube,
      url: "https://youtube.com/@boysquartersafrica?si=Z5F2NrLRrfpPdWOA",
      name: "YouTube",
    },
  ]

  return (
    <div className={`${className ? className : "mt-16 lg:mt-24"} bg-[#161616] text-[#F7F8FA]`}>
      <div className="px-4 lg:px-16 pt-16 md:pt-24">
        <div className="flex flex-col lg:flex-row justify-between items-center sm:items-start xl:items-center gap-10">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 lg:gap-10 w-full lg:w-auto">
            ...
            <div className="space-y-4 text-center sm:text-left">
              ...
              <p className="flex flex-col sm:flex-row gap-1 sm:gap-2 items-center sm:items-start justify-center sm:justify-start">
                ...
                <a href="mailto:hello@boysqafrica.org">hello@boysqafrica.org</a>|
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      ...
                      aria-label={`Visit Boys Quarters Africa on ${social.name}`}
                    >
                      <Icon className="h-8 w-8 text-black bg-white rounded-full p-1.5 hover:bg-primary hover:text-white transition-colors" />
                    </a>
                  )
                })}
              </div>
          ...
          {/* Newsletter */}
          <form onSubmit={handleSubmit} className="w-full max-w-xs sm:ml-32 lg:ml-0 text-center sm:text-left">
            ...
            <div className="relative flex items-center w-full">
              <input
                ...
                required
              />
              <button type="submit" className="absolute right-2 bg-primary text-white p-2 rounded-lg">
        ...
        <div className="border-t border-[#4F4F4F] py-4 mt-8 text-center">
          <p>Boys Quarters Africa ©{currentYear} All Rights Reserved.</p>
        </div>
      </div>
    </div>
  )
