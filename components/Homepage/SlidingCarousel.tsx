...
const SlidingCarousel = () => {
  return (
    <div className='container mx-auto pl-4 md:pl-28'>
      <div className=''>
        ...
        <p className='text-secondary text-3xl md:text-[40px] font-medium mt-5 mb-10 leading-tight md:pr-28 pr-4'>
          At Boys Quarters Africa, we are committed to
          driving positive change through our range of
