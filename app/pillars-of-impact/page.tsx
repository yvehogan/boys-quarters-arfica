    ...
    <div>
      <div className="bg-[url('/images/pillars-of-impact.png')] bg-cover bg-center h-screen relative mb-32">
        <div className="w-full px-16 h-full flex flex-col">
          <Header />
          <div className="w-[calc(100%-35rem)] bg-primary absolute -bottom-16 right-0">
      ...
      <div className="py-16">
        <h3 className="text-[48px] font-semibold text-center mb-20">
          Leadership
        </h3>
        <div className="w-full px-16 flex gap-12 justify-between">
          <div className="w-1/2">
            <p className="text-secondary text-xl leading-9 pr-8">
      ...
      <div className="py-16 bg-lightOrange">
        <div className="w-full px-16">
          ...
          <div className="flex items-center gap-10 justify-between mb-16">
            <div className="w-1/2">
              <Image
          ...
          <h3 className="text-[32px] font-semibold mb-4">Flagship Project</h3>
      ...
      <div className="w-full py-16 px-16">
        <div className="w-full px-16">
          <h3 className="text-[48px] font-semibold text-center mb-14">
            Empowerment
          </h3>
          <div className="flex items-center gap-8 justify-between mb-32">
            <div className="w-1/2">
              <p className="text-secondary text-xl leading-9">
      ...
      <div className="py-16 bg-lightOrange">
        <div className="w-full px-16">
          ...
          <div className="flex items-center gap-10 justify-between mb-20">
            <div className="w-1/2">
              <Image
                src="/svgs/advocacy.svg"
                alt=""
                layout="responsive"
                width={400}
                height={400}
          ...
          <div className="flex gap-10 justify-between mb-16">
            <div className="w-1/2 pl-5">
              ...
              <p className="mt-5 text-secondary text-xl">Where Rape will be Rape, irrespective of the Gender</p>
              <ul className="list-disc pl-10 text-secondary text-xl leading-9 pr-8 mt-2">
                <li className="">Create a channel for pyscho-socio support. Engagement and connection with Psychologists, Psychotherapists & Counsellors. A pool of first responders.</li>
                <li>The focus is healing for the abused-Closure and Healing.
                </li>
