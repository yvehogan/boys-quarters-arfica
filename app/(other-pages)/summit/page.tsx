...
const speakers = [
  ...
  },
  {
    name: 'Kola Oyeneyin',
    title:
      'CEO/CIO, Opportunik Global Fund - Keynote Speaker',
  ...
  return (
    <div className='w-full bg-[#F2EFEA] flex flex-col gap-3'>
      <section className='relative  md:min-h-screen'>
              ...
              <div className='flex items-center gap-1 w-full justify-center '>
                <div className='relative w-fit text-center '>
                  ...
                  <h2 className='text-secondary text-2xl font-medium text-center'>
                    Redefining Masculinity - Boys to
                    Wholesome Men
                  </h2>
                </div>
              </div>
        ...
        />
        <Image
          src='/images/events/powered.png'
          alt=''
          height={150}
          width={150}
          priority
          className='hidden md:block absolute bottom-10 z-50 left-[5rem]'
        />
      ...
      <section className='relative md:py-10  w-full px-4 lg:px-28  flex flex-col'>
        <div className='flex flex-col gap-8 md:flex-row md:justify-between '>
          ...
          <div className='md:w-1/2 md:leading-[30px] tracking-[1%]'>
            <p>
              On Friday, May 16th, 2025, Boys Quarters
              Africa (BQA) will host the largest Boy-focused
              summit in Africa- BQA International Boy Child
              Summit 2025, in celebration of the
              International Day of the Boy Child. This
              landmark event will bring together 20,000
              young boys, educators, and thought leaders to
              address one of the most pressing issues of our
              time: redefining masculinity and empowering
              boys to transition purposefully from boyhood
              to exceptional manhood.
            </p>
            <p className='mt-6 font-semibold'>
              {' '}
              Keynote Speech | Panel Session | Debate
              Competition | Mental Health Booth
            </p>
          </div>
        </div>
      </section>
      ...
      <section className=' md:py-10 py-10  w-full px-4 lg:px-28 '>
        ...
        <h2 className='text-center md:text-5xl text-4xl  md:leading-[60px] tracking-tight font-historia mt-2'>
          Get inspired by influential leaders, mentors, and
          changemakers who are shaping the future
        </h2>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-x-10 mt-12'>
          {speakers.map((speaker, index) => (
            <div
              key={index}
              className='flex flex-col gap-6 text-[#2F2F2F]'
            >
              <Image
                src={speaker.image}
                alt={speaker.name}
      ...
      <section className='md:py-8 md:pb-10 py-10  w-full px-4 lg:px-28 '>
        ...
        <h2 className='text-center md:text-5xl text-4xl  md:leading-[60px] tracking-tight font-historia mt-2'>
          We are proud to collaborate with leading brands
          that share our mission of empowering boys.
        </h2>
      ...
      <section className='md:py-8 md:pb-10 py-10  w-full px-4 lg:px-28 text-white bg-[#2F2F2F]'>
        <div className='flex flex-col gap-10 md:flex-row justify-between items-center'>
          <p className=' md:text-5xl text-4xl  md:leading-[90px] tracking-[1%] font-historia '>
            Are you ready to be part of a life-changing
            experience?
          </p>
          <div className='  flex text-center '>
            <Button
