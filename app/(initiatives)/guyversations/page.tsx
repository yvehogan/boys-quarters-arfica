      ...
      <div className='lg:pr-20  flex flex-col lg:flex-row justify-between my-24 '>
        <div className='bg-[#F2EFEA] lg:pl-20 pl-8 w-full py-10 pb-16 lg:py-20 pr-8 lg:pr-10 '>
          <p className='mt-12 text-2xl'>
            There are basically three elements to these
            men-themed conversations;{' '}
            <span className='font-semibold'>
              Uninhibited Openness, Beautiful
              Vulnerabilities
            </span>{' '}
            and of course,{' '}
            <span className='font-semibold'>
            ...
            Since the maiden edition on the 12th of April,
            2020, we&apos;ve had about 15 Guests, across
            different walks of life, discussing issues that
            relate to GUYS! The cumulative digital footprint
            is about 2,500 audience and traction gained
            shows the quantum of impact on the minds of
            young men.
          </p>
        </div>
