        ...
        <div className='flex flex-col md:flex-row justify-between'>
          <div className='md:w-1/2'>
            ...
            <p className='mt-4 text-lg'>
              ...
              pidgin-english, Nigerian expression of “Do you
              know?” If further broken down, for us, it
              means “what are you doing to educate local
              communities on the effects and dimensions of
